...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    if voltage*current/ theoretical_max_power * 100 < 30:
        return "black"
    if voltage*current / theoretical_max_power * 100 > 29 and voltage*current / theoretical_max_power * 100 < 60:
        return "red"
    if voltage*current / theoretical_max_power * 100 > 59 and voltage*current / theoretical_max_power * 100 < 80:
        return "orange"
    if voltage*current / theoretical_max_power * 100 > 79:
        return "green"
