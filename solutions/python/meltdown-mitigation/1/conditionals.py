...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    if voltage*current/ theoretical_max_power * 100 < 30:
        return "black"
    elif voltage*current / theoretical_max_power * 100 > 29 and voltage*current / theoretical_max_power * 100 < 60:
        return "red"
    elif voltage*current / theoretical_max_power * 100 > 59 and voltage*current / theoretical_max_power * 100 < 80:
        return "orange"
    elif voltage*current / theoretical_max_power * 100 > 79:
        return "green"
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    if temperature * neutrons_produced_per_second < threshold - (threshold * .1):
        return "LOW"
    elif temperature * neutrons_produced_per_second < threshold + (threshold * .1):
        return "NORMAL"
    else:
        return "DANGER"
